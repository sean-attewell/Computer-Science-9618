...
# This changes to error number to hexadecimal

# ***************************************************************
# Stop here unless you think you'll need to know about older formats for the exam
# I'll copy my notes on other ways to format strings below
# You will run across all kinds out there in the real world
# ***************************************************************
